    ...
    <DndWrapper items={items} setItems={setItems} isSingleColumn={isMobile}>
      ...
      {isMobile && (
        <div className="flex justify-center">
          <span className="text-sm text-gray-500 text-center">Batafsil ma'lumot olish uchun chapga yoki o'ngga suring</span>
        </div>
      )}
    </DndWrapper>
  )
...
function DndWrapper({ items, setItems, isSingleColumn, children }: PropsWithChildren<{
  ...
  // Animatsiya shovqinlaridan saqlaning
      ...
      <div className={$("flex justify-between mx-2 items-center")}>
        <div className="flex gap-2 items-center">
          ...
          <span className="flex flex-col">
            ...
            <span className="text-xs op-70">Sudrash</span>
          </span>
        </div>
